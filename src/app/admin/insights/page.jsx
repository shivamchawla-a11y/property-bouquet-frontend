      ...
      <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1 text-sm">
            Manage market reports, articles, location guides and luxury real estate insights
          </p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
        ...
        <div className="grid xl:grid-cols-5 gap-3">
          ...
          >
            ...
            <option value="Branded Residences">
              Branded Residences
            </option>

            <option value="Developer News">
              Developer News
            </option>

            <option value="Location Guide">
              Location Guide
            </option>
          </select>
