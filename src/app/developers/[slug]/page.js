...
export default function DeveloperSlugPage() {
  ...
  // ============================================================
  // FILTERING
  // EXACT SAME APPROACH AS PROPERTIESCLIENT
  // ============================================================
  ...
  useEffect(() => {
    ...
    // DEVELOPER
    // ==========================================================
    // The API already returns properties for this developer.
    // We still keep the same matching behavior so URL
    // developer params continue to work consistently.
    // ==========================================================
    ...
    if (budget) {
      ...
      result = result.filter(
        (property) => {
          // Price on request should always
          // remain visible in budget searches.
          if (
                  ...
                  (property) => (
                    ...
                    >
                      ...
                      <Link
                        ...
                        aria-label={`View ${property?.coreDetails?.title || "property"}`}
                      />
