...
export const metadata = {
  ...
  description:
    "Explore the Property Bouquet sitemap to discover luxury properties, leading real estate developers, prime Gurgaon locations, property insights, knowledge resources, real estate tools and important legal information.",
  ...
  openGraph: {
    ...
    title: "Luxury Real Estate Sitemap | Property Bouquet",
    description:
      "Explore luxury properties, leading developers, prime Gurgaon locations, real estate insights, knowledge resources, tools and important legal information across Property Bouquet.",
  },
  ...
  twitter: {
    ...
    title: "Luxury Real Estate Sitemap | Property Bouquet",
    description:
      "Explore luxury properties, leading developers, prime Gurgaon locations, insights, knowledge, tools and important information.",
  },
...
async function getPublishedProperties() {
  try {
    ...
    if (!res.ok) {
      console.warn(
        `Sitemap page properties request failed: ${res.status}`
      );
    ...
    const properties = extractArray(result);
    ...
    console.error(
      "Sitemap properties fetch failed:",
      error
    );
...
async function getActiveDevelopers() {
  try {
    ...
    if (!res.ok) {
      console.warn(
        `Sitemap page developers request failed: ${res.status}`
      );
    ...
    const developers = extractArray(result);
    ...
    console.error(
      "Sitemap developers fetch failed:",
      error
    );
...
function groupPropertiesByDeveloper(
  properties
) {
  const grouped = {};
...
const legalLinks = [
  {
    ...
    href: "/privacy-policy",
    description:
      "Learn how Property Bouquet collects, uses and protects personal information.",
    icon: ShieldCheck,
  },

  {
    ...
    href: "/disclaimer",
    description:
      "Important information regarding property listings, pricing, availability and website content.",
    icon: FileText,
  },

  {
    ...
    href: "/terms-of-use",
    description:
      "Review the terms and conditions governing your use of the Property Bouquet website.",
    icon: Scale,
  },
];
...
export default async function SitemapPage() {
  ...
  const groupedProperties =
    groupPropertiesByDeveloper(
      properties
    );

  /*
   * Use actual developer records where available.
   *
   * This prevents the sitemap page from creating an
   * incorrect developer URL from the display name.
   *
   * If a developer cannot be matched to a property group,
   * it is still displayed because it is an active CMS
   * developer.
   */
    ...
    "@graph": [
      {
        ...
        name:
          "Luxury Real Estate Sitemap | Property Bouquet",

        description:
          "Explore the Property Bouquet sitemap covering luxury properties, real estate developers, prime Gurgaon locations, property insights, knowledge resources, real estate tools and legal information.",
...

      {
        ...
        "@id": `${SITE_URL}/sitemap#primary-navigation`,

        name:
          "Property Bouquet Website Sections",
...

      {
        ...
        "@id": `${SITE_URL}/sitemap#resources`,

        name:
          "Property Bouquet Resources",

        description:
          "Property insights, knowledge resources and real estate tools available on Property Bouquet.",
...

      {
        ...
        "@id": `${SITE_URL}/sitemap#legal`,

        name:
          "Property Bouquet Legal & Policies",

        description:
          "Legal policies and terms governing use of the Property Bouquet website.",
      ...
      <main className="min-h-screen overflow-hidden bg-[#f8f7f3] text-[#10231f]">
        ...
        <section className="relative overflow-hidden bg-[#061914]">
          ...
          <div className="pointer-events-none absolute inset-0">
            ...
            <div className="absolute bottom-[-30%] left-[-15%] h-[500px] w-[500px] rounded-full bg-[#17483b]/50 blur-[100px]" />
            ...
            <div className="grid items-end gap-14 lg:grid-cols-[1.25fr_.75fr]">
              ...
              <div>
                ...
                <p className="mt-7 max-w-2xl text-sm leading-7 text-white/60 sm:text-base sm:leading-8">
                  Explore the complete Property
                  Bouquet ecosystem — from
                  distinguished residences and
                  leading developers to prime
                  locations, market intelligence,
                  expert resources and important
                  legal information.
                </p>
              ...
              <div className="lg:justify-self-end">
                ...
                <div className="relative overflow-hidden border border-white/10 bg-white/[0.045] p-6 backdrop-blur-xl sm:p-7">
                  ...
                  <div className="absolute right-0 top-0 h-20 w-20 border-b border-l border-[#c9a64b]/20" />
              ...
              (item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute right-0 top-0 h-8 w-8 border-b border-l border-[#c9a64b]/20 opacity-0 transition duration-500 group-hover:opacity-100" />
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <ArrowUpRight
                        size={16}
                        className="text-[#a8aaa3] transition duration-300 group-hover:-translate-x-[-4px] group-hover:-translate-y-1 group-hover:text-[#a47c32]"
                      />
                ...
                (developer) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute right-0 top-0 h-12 w-12 border-b border-l border-[#c9a64b]/15 transition group-hover:border-[#c9a64b]/40" />
        ...
        <section className="relative overflow-hidden bg-[#071b16]">
          ...
          <div className="pointer-events-none absolute inset-0">
            ...
            <div className="absolute bottom-[-20%] right-[-10%] h-[500px] w-[500px] rounded-full bg-[#164638]/60 blur-[100px]" />
        ...
        <section className="border-t border-[#dedbd2] bg-[#f1efe8]">
          ...
          <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
            ...
            <SectionIntro
              ...
              description="Review the policies and terms that govern your use of Property Bouquet."
            />
                ...
                (item) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group relative overflow-hidden border border-[#d8d5cb] bg-[#faf9f5] p-7 transition duration-500 hover:-translate-y-1 hover:border-[#c9a64b]/50 hover:bg-white"
                    >
                      ...
                      <h3 className="mt-7 font-serif text-xl font-light text-[#182923] transition group-hover:text-[#8d6927]">
                        {
                          item.title
                        }
                      </h3>

                      <p className="mt-3 text-[13px] leading-6 text-[#69716d]">
                        {
                          item.description
                        }
                      </p>

                      <div className="mt-7 flex items-center gap-2 text-[10px] font-medium uppercase tracking-[0.18em] text-[#9b752f]">
        ...
        <section className="px-6 pb-20 lg:px-8 lg:pb-28">
          ...
          <div className="relative mx-auto max-w-7xl overflow-hidden bg-[#071b16]">
            ...
            <div className="pointer-events-none absolute inset-0">
              ...
              <div className="absolute bottom-0 left-0 h-[200px] w-[500px] bg-[#c9a64b]/5 blur-[90px]" />
            ...
            <div className="relative grid items-center gap-10 px-7 py-12 sm:px-10 lg:grid-cols-[1fr_auto] lg:px-14 lg:py-14">
              ...
              <div>
                ...
                <p className="mt-4 max-w-xl text-sm leading-7 text-white/50">
                  ...
                  guidance across Gurgaon’s
                  finest residential destinations.
                </p>
